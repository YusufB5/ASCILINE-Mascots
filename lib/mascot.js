...
function buildCollisionCache() {
    ...
    textContainers.forEach(container => {
        ...
        if (container.closest('#excalibur-zone') || container.closest('.excalibur-section')) return; // Excalibur section elements are excluded from platform collision
        if (container.closest('#aquarium-section-container') || container.closest('.aquarium-wrapper') || container.closest('.asciline-water') || container.closest('#asciquarium')) return; // Aquarium section elements are excluded from platform collision
